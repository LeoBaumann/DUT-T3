...
namespace T3
{
    public partial class FormRegles : Form
    {
        ...
        /// <summary>
        /// Constructeur de FormRegles
        /// </summary>
        public FormRegles()
        {
            InitializeComponent();
            pctRegles2.Visible = false;
        }
        ...
        /// <param name="sender">Objet référence qui a déclenché l'évènement</param>
        /// <param name="e">L'évenement lancé</param>
        private void FormRegles_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        {
            if (!pctRegles2.Visible)
            {
                pctRegles2.Visible = true;
                pctRegles1.Visible = false;
            }
        }
        ...
        {
            if (!pctRegles1.Visible)
            {
                pctRegles2.Visible = false;
                pctRegles1.Visible = true;
            }
        }
    }
}
